...
def main():
    ...
    with httpx.Client(base_url=args.base_url.rstrip("/") + "/api/v1/factory/", timeout=210,
        ...
        body = {"provider_id": args.provider_id, "provider": "litellm", "idempotency_key": str(uuid4()),
        ...
        if args.full:
            ...
            if not (stages["context"].get("used") and stages["architecture"].get("c4_dsl") == "parser_validated"
